...
*\=\=\=\= Важно \=\=\=\=*
Тикток вечерок и видео\-вечерок взаимозаменяемые\. Если начат набор тиктоков на тиктоквечерок, все видео будут приходить туда\. Если начат набор видео на видеовечерок \- все отправленные видео придут на видеовечерок\.
...
*Видео\-вечерок*
Отправить сообщение о наборе видео \- /start\_videos
Начать оценивать видео \- /start\_video\_rating
Опубликовать пост с итогами \- /publish\_video\_evening
